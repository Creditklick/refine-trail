...
axios.post('http://localhost:8801/refine',values).then(navigate('/Payments'))
                ...
                <div className="w-full px-6">
                    <div className="mt-8 relative rounded-lg bg-indigo-700 container mx-auto flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
                        ...
                        <div className="w-11/12 sm:w-2/3 mb-5 sm:mb-10">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-white font-bold leading-tight">We manage factors that positively impact your credit.</h1>
                        </div>
                   ...
                   <form  novalidate onSubmit={handlefinal}>
                      ...
                      <div className="md:flex items-center mt-12">
                          ...
                          <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                              <label className="text-xl font-semibold leading-none text-gray-800">Email Address
                           
                              </label> 

                              <input tabIndex={0} arial-label="Please input email address" type="email" name="email" className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-purple-100 border rounded border-gray-200 shadow-lg placeholder-gray-500 rounded-xl invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" placeholder="Please input email address"
                      ...
                      <div className="md:w-72 flex flex-col">
                              <label className="text-xl font-semibold leading-none text-gray-800">Mobile No.</label>


                              <input tabIndex={0}  arial-label="Please input company name" type="number" name="phone" className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-purple-100 border shadow-lg rounded border-gray-200 placeholder-gray-500 rounded-xl" placeholder="Please input phone number" onChange={handleChange} />
                          </div>
                      ...
                      <div className='my-8'>
                        ...
                        <div className="w-full flex flex-col mt-4 bg-pink-200 p-3 rounded-xl shadow-lg">
                           <span className='mb-3'>
                            ...
                            <input type="checkbox" onChange={(e)=>setValues({...values,query:e.target.value})} value="Need fresh loan/CC to clear outstandings?"  />
                            <label  className='text-base font-semibold mx-3 text-gray-700'>Need fresh loan/CC to clear outstandings?</label>
                        </span>


                        <span className='my-3'>
                            <input type="checkbox"  onChange={(e)=>setValues({...values,query:e.target.value})} value="Settle the existing loan" />
                            <label  className='text-base font-semibold mx-3 text-gray-700'>Settle the existing loan</label>
                        </span>


                        <span className='my-3'>
                            <input type="checkbox"  onChange={(e)=>setValues({...values,query:e.target.value})} value="Pay partial payment of existing account and pay in EMIs" />
                            <label  className='text-base font-semibold mx-3 text-gray-700'>Pay partial payment of existing account and pay in EMIs</label>
                        </span>


                        <span className='my-3'>
                            <input type="checkbox"  onChange={(e)=>setValues({...values,query:e.target.value})} value="Just want to improve the credit score" />
                            <label  className='text-base font-semibold mx-3 text-gray-700'>Just want to improve the credit score</label>
                        </span>


                        <span className='my-3'>
                            <input type="checkbox"  onChange={(e)=>setValues({...values,query:e.target.value})}  value="Get rid off the recurring phone calls of recovery"/>
                            <label  className='text-base font-semibold mx-3 text-gray-700'>Get rid off the recurring phone calls of recovery</label>
                        </span>


                        <span className='my-3'>
                            <input type="checkbox"  onChange={(e)=>setValues({...values,query:e.target.value})} value="Close existing account" />
                            <label  className='text-base font-semibold mx-3 text-gray-700'>Close existing account</label>
                        </span>


                        <span className='mt-3'>
                            <input type="checkbox" value="others"  onChange={(e)=>setValues({...values,query:e.target.value})} />
                      ...
                      <div id="button" className="  container mx-auto justify-center items-center px-4 md:px-10 pb-10 mt-4">
                        
                          <button type='submit' className="mt-5 bg-blue-500 py-3 rounded-md text-white group-invalid:pointer-events-none group-invalid:opacity-50 mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-indigo-500 rounded hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none rounded-full">SUBMIT</button>
                      </div>
